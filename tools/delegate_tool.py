    ...
    try:
        ...
        try:
            ...
            while True:
                ...
                try:
                    result = _child_future.result(timeout=min(0.1, remaining))
                    break
                    ...
                    child_interrupted = (
                        getattr(child, "_interrupt_requested", False) is True
                    )
                    if not (parent_interrupted or child_interrupted):
                        continue
                    try:
                    ...
                    result = {
                        ...
                        "interrupt_message": getattr(
                            parent_agent, "_interrupt_message", None
                        ),
                    }
                    break
